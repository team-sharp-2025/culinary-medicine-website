    ...
    <div className="min-h-screen pt-16 md:pt-20">
      ...
      <div className="bg-gradient-to-r from-teal-500 to-blue-500 py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Evidence-based insights, practical tips, and delicious recipes to
            help you harness the power of food as medicine.
          </motion.p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-gray-600 text-center mb-6">
            Get the latest articles, recipes, and health tips delivered to your
            inbox.
          </p>
