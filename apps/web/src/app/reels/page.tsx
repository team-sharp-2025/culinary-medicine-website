    ...
    <div className="min-h-screen pt-16 md:pt-20 pb-16">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-teal-500 py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Quick, informative videos on nutrition, healthy cooking, and food as medicine.
          </motion.p>
        </div>
      </div>
        ...
        <div className="mt-16 bg-gray-50 p-8 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-medium text-lg text-gray-800 mb-2">Anti-inflammatory Foods</h3>
              <p className="text-gray-600 mb-2">Learn which foods can help reduce inflammation and improve overall health.</p>
              <span className="text-teal-600 font-medium">6 videos</span>
            </div>
            
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-medium text-lg text-gray-800 mb-2">Cooking for Gut Health</h3>
              <p className="text-gray-600 mb-2">Discover recipes and techniques to support a healthy microbiome.</p>
              <span className="text-teal-600 font-medium">8 videos</span>
            </div>
            
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-medium text-lg text-gray-800 mb-2">Meal Prep Masterclass</h3>
              <p className="text-gray-600 mb-2">Simple strategies to prepare healthy meals in advance for busy weeks.</p>
