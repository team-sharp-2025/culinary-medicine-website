...
const ContactForm: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-blue-50 to-teal-50" id="contact">
      <div className="container mx-auto px-4">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-serif text-3xl text-gray-800 font-bold mb-4">Get in Touch</h2>
          <p className="text-gray-600 leading-relaxed">
            Have questions about how culinary medicine can help you? Send us a message and we'll get back to you as soon as possible.
          </p>
        </motion.div>
